# icon semiotics for RWA

not necessarily B2B, but most examples from it

complete guide based on existing defensive material + 1/3 of generation how to + actio plan blueprint

as a slidedeck training
