...
- pas faire des wireflows / sitemap pour tout (cest bcp de travail/maintenance
- mais utile pour comparer (consistence, gouvernance, IA) ou expliquer/presenter
- d’une maniere que d’autres livrables ne peuvent pas trop faire (effet “at a glance”) (eg vs essai et erreur de prototype)
- couleurs neutres car vives requises pour encodage
- fisheye sur le “produit”, pas sur “tout”
- nomenclaturer TOUT clairement
- golden path
- organiser spatialement
- clareté avant complétude etc etc (sans être misleading)
- montrer (car unique) : vues, containers
- ne pas montrer (car trivial) : erreurs, messages, liminal conditions
